...
from cognite.experimental.data_classes.utils.rules_output import _label_groups
...
class RuleEditor:
    ...
    def display_fancy_match(self):
        ...
        self.fancy_match.value = _color_matches(extractors, [info["matches"][match_index]])
